...
import {PaymentColorsResult, PaymentColorsTotal} from '../../utils/payments-color-utils';
...
export interface IDrawer {
  drawBar(content: any, xScale: ScaleBand<any>, yScale: d3.ScaleLinear<number, number>): void;

  drawTransition(svg: any, xScale: ScaleBand<any>, yScale: d3.ScaleLinear<number, number>): void;
...
abstract class AbstractBarChartDrawer implements IDrawer {
  private static readonly amountPipe: AmountPipe = new AmountPipe();

  public constructor(protected data: PaymentColorsResult) {
  }

  abstract drawBar(content: any, xScale: ScaleBand<any>, yScale: d3.ScaleLinear<number, number>): void;

  abstract drawTransition(svg: any, xScale: ScaleBand<any>, yScale: d3.ScaleLinear<number, number>): void;
  ...
  drawLabels(content: any, xScale: ScaleBand<any>, yScale: d3.ScaleLinear<number, number>): void {
    content.append('g')
      ...
      .attr('y', d => yScale(d.amount) + this.getLabelParams().yOffset)
